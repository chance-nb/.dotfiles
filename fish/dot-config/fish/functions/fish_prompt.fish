function fish_prompt --description 'Write out the prompt'
    ...
    or set -lx fish_prompt_pwd_full_dirs 3
    ...
    # enable informative git
    set -q __fish_git_prompt_show_informative_status
    or set -lx __fish_git_prompt_show_informative_status true 
    set -lx __fish_git_prompt_use_informative_chars false
